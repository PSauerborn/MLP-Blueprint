...
class MLPClassifierModel():
    ...
    def __init__(self, n_features, n_classes, hidden_layers={'n_layers': 2, 'unit_count': (50, 25), 'activation': (tf.nn.relu, tf.nn.relu)}, eta=0.01, n_epochs=100, random_state=1):
    ...
    def build(self, n_features, n_classes, hidden_layers):
        ...
        # finally a training operator is defined
